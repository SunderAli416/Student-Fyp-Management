...
{
    public partial class JuryEdit : Form
    {
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            string query = $"update jury set fc_1='{fac1}',fc_2={fac2},fc_3={fac3},ex_1={ext1},ex_2={ext2} where jury_id='{jid}';";
        ...
        public JuryEdit(string jid,string fac1,string fac2,string fac3,string ext1,string ext2)
        {
            this.jid = jid;
            this.fac1 = fac1;
            this.fac2 = fac2;
            ...
            this.ext2 = ext2;
            InitializeComponent();
            fac1Button.Text = fac1;
            fac2Button.Text = fac2;
            fac3Button.Text = fac3;
            ext1Button.Text = ext1;
            ext2Button.Text = ext2;
        }
        ...
        private void JuryEdit_Load(object sender, EventArgs e)
        {
            Connection.MakeConnection();
